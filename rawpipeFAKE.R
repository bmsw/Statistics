...
gate.name="Bact tot"; ialpha="invsimpson"; ibeta="bray"; do.plot=TRUE; static=FALSE; dilutions=DATA$`x (flowDiv)`;  pmax=0.05; env=NULL; use.beads=FALSE; beads=NULL; transform.hell=FALSE; dimension=20; psize=3; autotrans=TRUE
#"raw" flowDiv
