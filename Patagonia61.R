...
library("gplots")
## Sourcing flowDiv
source("/home/brunomsw/Documentos/DOUTORADO/DATA/Patagonia/Scripts&Data/flowDiv_internals.R")
source("/home/brunomsw/Documentos/DOUTORADO/DATA/Patagonia/Scripts&Data/flowDiv_main.R")
## Sourcing data
