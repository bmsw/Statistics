...
traits2$SSC.H<-as.numeric(traits2$SSC.H)
traits2$FITC.H<-as.numeric(traits2$FITC.H)
traits2$PerCP.Cy5.5.H<-as.numeric(traits2$PerCP.Cy5.5.H)

traits2$SSC.H
traits2$FITC.H
traits2$PerCP.Cy5.5.H


traits2$PerCP.Cy5.5.H[traits2$PerCP.Cy5.5.H > 0 & traits2$PerCP.Cy5.5.H <= 15] <- 1
traits2$PerCP.Cy5.5.H[traits2$PerCP.Cy5.5.H > 15 & traits2$PerCP.Cy5.5.H <= 30] <- 2
traits2$PerCP.Cy5.5.H[traits2$PerCP.Cy5.5.H > 30 & traits2$PerCP.Cy5.5.H <= 44] <- 3

traits2$SSC.H[traits2$SSC.H > 0 & traits2$SSC.H <= 15] <- 1
traits2$SSC.H[traits2$SSC.H > 15 & traits2$SSC.H <= 30] <- 2
traits2$SSC.H[traits2$SSC.H > 30 & traits2$SSC.H <= 44] <- 3

traits2$FITC.H[traits2$FITC.H > 0 & traits2$FITC.H <= 15] <- 1
traits2$FITC.H[traits2$FITC.H > 15 & traits2$FITC.H <= 30] <- 2
traits2$FITC.H[traits2$FITC.H > 30 & traits2$FITC.H <= 44] <- 3


teste=dbFD(traits2, abund2)
...
names=c("a","d","d","e","f",colnames(metadata)[c(4:41, 52:55)])
dataall<-cbind(rich, pielou, shannon, simpson, invsimpson,metadata[,c(4:41, 52:55)])

# Analise exploratoria
## Plots pareados
par(mfrow=c(4,4))
for (i in 6:47) plot(dataall$rich, dataall[,i], ylab=names[i])
